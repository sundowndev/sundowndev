...
- [sundowndev/goreleaser-template](https://github.com/sundowndev/goreleaser-template) ([v0.3.4](https://github.com/sundowndev/goreleaser-template/releases/tag/v0.3.4), 2 days ago) - Repository template for shipping a Go binary with Go Releaser
- [cloudskiff/driftctl](https://github.com/cloudskiff/driftctl) ([v0.12.0](https://github.com/cloudskiff/driftctl/releases/tag/v0.12.0), 4 days ago) - Detect, track and alert on infrastructure drift
