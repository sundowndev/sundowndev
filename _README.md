...
- [sundowndev/goreleaser-template](https://github.com/sundowndev/goreleaser-template) ([v0.3.3](https://github.com/sundowndev/goreleaser-template/releases/tag/v0.3.3), today) - Repository template for shipping a Go binary with Go Releaser
